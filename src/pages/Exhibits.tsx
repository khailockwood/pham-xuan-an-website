      ...
      <div className="grid md:grid-cols-2 gap-8">
        {exhibits.map((ex) => (
          <Link
            key={ex.slug}
            to={`/exhibits/${ex.slug}`}
            className="group block border border-border bg-card hover:border-accent transition-colors"
          >
            ...
            <div className="p-6">
              <h2 className="font-display text-2xl leading-tight mb-2 group-hover:text-accent transition-colors">
                {t(ex.title)}
              </h2>
